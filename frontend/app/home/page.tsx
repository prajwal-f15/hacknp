    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-slate-100 relative">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-[90px] sm:pt-[100px] pb-8 sm:pb-12">{/* pt-[100px] accounts for fixed navbar */}
        ...
        <section className="bg-slate-700/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-12 lg:p-16 shadow-2xl border border-slate-600/50 hover:shadow-[0_20px_80px_rgba(0,0,0,0.15)] transition-all duration-500">
          <div className="text-center">
            <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-gradient-to-r from-blue-600/20 to-purple-700/20 border border-slate-700/50 mb-6">
              ...
              <span className="text-sm font-medium text-slate-200">Patient Health Dashboard</span>
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 mb-4 sm:mb-6" style={{ fontFamily: 'Righteous, sans-serif' }}>Welcome to Your Health Dashboard</h1>
            <p className="mt-4 text-base sm:text-lg lg:text-xl text-slate-200 max-w-2xl mx-auto">Manage your medical records, view summaries, and track your health journey.</p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/search" className="group inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl bg-slate-800 border-2 border-blue-500/50 text-white font-semibold hover:bg-slate-700 hover:border-purple-500/50 transition-all duration-300 shadow-xl">
        ...
        <section className="mt-8 sm:mt-12">
          <h2 className="text-2xl font-bold text-white mb-6 text-center">Your Health Overview</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="group relative rounded-2xl bg-gradient-to-br from-blue-600/20 to-blue-700/20 backdrop-blur-lg p-6 border border-slate-600/50 hover:shadow-xl hover:scale-105 transition-all duration-300">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Your Records</h3>
                <p className="text-sm text-slate-200">Access and manage your medical summaries securely.</p>
              </div>
            </div>
            ...
            <div className="group relative rounded-2xl bg-gradient-to-br from-purple-600/20 to-purple-700/20 backdrop-blur-lg p-6 border border-slate-600/50 hover:shadow-xl hover:scale-105 transition-all duration-300">
              ...
              <div className="relative">
                ...
                <p className="text-sm text-slate-200">Get AI-powered health recommendations based on your records.</p>
              </div>
            </div>
            ...
            <div className="group relative rounded-2xl bg-gradient-to-br from-pink-600/20 to-pink-700/20 backdrop-blur-lg p-6 border border-slate-600/50 hover:shadow-xl hover:scale-105 transition-all duration-300">
              ...
              <div className="relative">
                ...
                <p className="text-sm text-slate-200">Your data stays on your device. Complete privacy guaranteed.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mt-12">
          <h2 className="text-2xl font-bold text-white mb-6">Patient Dashboard</h2>
